...
export const Header = () => {
  ...
  return (
    <header className="bg-white/90 backdrop-blur-md sticky top-0 z-50 border-b border-blue-100">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Hubnex Academy</h1>
