...
export const CareerCounsellingForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Insert into the leads table with proper structure
      const { error } = await supabase
        ...
        .insert([{
          ...
          lead_source: 'website' as const, // Properly typed enum value
          status: 'fresh' as const, // Properly typed enum value
          deal_value: 0,
          // lead_id will be auto-generated by the trigger
        }]);
